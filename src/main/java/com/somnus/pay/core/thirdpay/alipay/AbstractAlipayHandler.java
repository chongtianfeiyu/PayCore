package com.somnus.pay.core.thirdpay.alipay;
...
import com.somnus.pay.core.thirdpay.alipay.config.AlipayConfig;
import com.somnus.pay.core.thirdpay.alipay.sign.MD5;
import com.somnus.pay.core.thirdpay.alipay.sign.RSA;
import com.somnus.pay.core.thirdpay.alipay.util.AlipayNotify;
...
public abstract class AbstractAlipayHandler extends PaymentChannelHandler {
	...
	public PaymentResult[] convert(Map<String, String> data) {
        try {
            ...
            throw new PayException(msa.getMessage(MsgCodeList.ERROR_600001));
        }
	}
	...
	public Map<String,String> queryPaymentOrder(Map<String, String> requestParamsMap, boolean isMD5SignType) {
        ...
        try {
        	...
        	throw new PayException(msa.getMessage(MsgCodeList.ERROR_600002));
        }
        return result;
    }
