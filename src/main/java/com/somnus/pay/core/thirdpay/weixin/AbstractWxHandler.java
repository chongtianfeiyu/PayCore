...
public abstract class AbstractWxHandler extends PaymentChannelHandler {
	...
	public Map<String, String> parseParam(Object data) {
		...
		try {
			...
			throw new PayException(msa.getMessage(MsgCodeList.ERROR_500000,new Object[]{}));
		}
	}
        ...
        if(isWap){
    		...
    		if(isRequestOpenid){
				...
				try {
					...
					throw new PayException(msa.getMessage(MsgCodeList.ERROR_500002,new Object[]{}));
				}
	...
	protected Map<String, String> handleQuery(RequestParameter<String, Map<String, String>> parameter) {
        ...
        try {
        	...
        	throw new PayException(msa.getMessage(MsgCodeList.ERROR_500001,new Object[]{}));
        }
	}
	...
	protected boolean handleConfirm(RequestParameter<String, PaymentResult> parameter) {
		...
		newParameter.setData(parameter.getParameter());
