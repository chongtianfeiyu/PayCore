...
import com.somnus.pay.core.pojo.PaymentPageChannel;
...
public class WebPayController extends PaymentController {
	...
	protected void createOrder(PaymentOrder paymentOrder, HttpServletRequest request, Model model) {
        ...
        PaymentPageChannel paymentPageChannel = /*configService.getPaymentPageChannel(paymentOrder.getCrossPay())*/null;
